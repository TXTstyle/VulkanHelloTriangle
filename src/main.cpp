...
class HelloTriangleApplication {
  ...
  private:
    ...
    void initWindow() {
        ...
        window = glfwCreateWindow(WIDTH, HEIGHT, "dev VulkanHelloTriangle",
                                  nullptr, nullptr);
    ...
    void createDepthResources() {
        ...
        transitionImageLayout(
            commandBuffer, depthImage, depthFormat, VK_IMAGE_LAYOUT_UNDEFINED,
    ...
    void createTextureSampler() {
        ...
        VkPhysicalDeviceProperties
            properties{}; // FIX; Dont querry every time. Pass around
    ...
    void createTextureImage() {
        ...
        generateMipmaps(commandBuffer, textureImage, VK_FORMAT_R8G8B8A8_SRGB, texWidth, texHeight,
                        mipLevels);
    ...
    // NOTE; Implement pre generated mips, instead of at runtime
    void generateMipmaps(VkCommandBuffer commandBuffer, VkImage image, VkFormat imageFormat,
    ...
    void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
        // FIX: abstract away cammand pool creation.
        ...
        if (vkCreateCommandPool(device, &poolInfo, nullptr, &copyCommandPool) !=
            VK_SUCCESS) {
            throw std::runtime_error(
                "failed to create copy buffer command pool");
        }
        // FIX

        VkCommandBuffer commandBuffer = beginSingleTimeCommand(copyCommandPool);
        ...
        endSingleTimeCommand(commandBuffer, copyCommandPool);
        vkDestroyCommandPool(device, copyCommandPool, nullptr); // With this!
    }
